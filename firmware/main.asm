...
static inline bool bootLoaderCondition(void)
{
  if (__BOOTLOADERENTRY_FROMSOFTWARE__bootup_MCUCSR & (~(_BV(WDRF)))) {
    7448:	80 91 3b 01 	lds	r24, 0x013B	; 0x80013b <__bss_end>
...
000074a6 <_mywait_sleeploop364>:
    ...
    750e:	80 93 09 01 	sts	0x0109, r24	; 0x800109 <__data_end+0x3>
        len = (usbMsgLen_t)4;
    ...
    7564:	90 93 10 01 	sts	0x0110, r25	; 0x800110 <usbMsgFlags>
        usbMsgLen = replyLen;
    7568:	80 93 00 01 	sts	0x0100, r24	; 0x800100 <__data_start>
    ...
    7578:	c0 91 00 01 	lds	r28, 0x0100	; 0x800100 <__data_start>
    ...
    758c:	90 93 00 01 	sts	0x0100, r25	; 0x800100 <__data_start>
    ...
    75dc:	80 93 00 01 	sts	0x0100, r24	; 0x800100 <__data_start>
    usbTxLen = len;
...
uchar   *dataPtr = usbTxBuf + 9;    /* there are 2 bytes free space at the end of the buffer */
    ...
    770e:	10 92 00 01 	sts	0x0100, r1	; 0x800100 <__data_start>
